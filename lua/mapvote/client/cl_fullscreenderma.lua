...
derma.DefineSkin( "KMapVoteFS", "Fullscreen KMapVote Skin", SKIN )

end --function loadSkin

hook.Add( "Initialize", "LoadKMapVoteFSSkin", loadSkin )
hook.Add( "OnReloaded", "ReLoadKMapVoteFSSkin", loadSkin )