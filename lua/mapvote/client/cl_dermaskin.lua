...
derma.DefineSkin( "KMapVoteDefault", "Default KMapVote Skin", SKIN )

end --function loadSkin

hook.Add( "Initialize", "LoadKMapVoteDefaultSkin", loadSkin )
hook.Add( "OnReloaded", "ReLoadKMapVoteDefaultSkin", loadSkin )